...
var stripe = Stripe('pk_test_51KwdJYHTkwmWJUsI0Xdd5yv6tlmthR4oLAcE3YHmalaRQPxj5GcEsQYJrkCNdImJZwUFMelMY62jgsbZuvsAyhws00JjClygpm');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (event) {
    ...
    var tourId = event.target.dataset.tourId.tourId;
